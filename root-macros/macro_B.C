...
void macro_B10(){
    ...
    h3->AddBinContent(2, InE5);
    h3->SetFillColor(kRed);  // Interact_Num 14
   ...
   legend->AddEntry(h1,"B11 no gamma");
   legend->AddEntry(h2,"B11 gamma");
   legend->AddEntry(h3,"Li7 + alpha + gamma");
   legend->AddEntry(h4,"Be isotope");
