...
class B4cDetectorConstruction : public G4VUserDetectorConstruction
{
  ...
  public:
    ...
    G4LogicalVolume* GetScoringVolume1a() const { return fScoringVolume1a; }
    G4LogicalVolume* GetScoringVolume1b() const { return fScoringVolume1b; }
    
    G4double DetectorPos; 
 ...
 //   G4int   fNofLayers;     // number of layers
  ...
  protected:
    ...
    G4LogicalVolume* fScoringVolume1a; 
    G4LogicalVolume* fScoringVolume1b; 
